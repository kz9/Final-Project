...
shinyServer(function(input, output, session) {
  ...
  output$pie_output <- renderPlot({
    build_pie(
      modified_data, input$pie_state, input$pie_site,
  ...
  output$plot_output <- renderPlotly({
    build_line(
      modified_data, input$plot_gender, input$plot_site,
  ...
  output$bar_output <- renderPlotly({
    build_bar(
      modified_data, input$bar_race, input$bar_site,
  ...
  output$sankey_output <- renderPlotly({
    build_sankey(
      modified_data, input$sankey_state, input$sankey_race,
